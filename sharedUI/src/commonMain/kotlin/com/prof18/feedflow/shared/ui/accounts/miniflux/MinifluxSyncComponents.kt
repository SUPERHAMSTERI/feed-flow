package com.prof18.feedflow.shared.ui.accounts.miniflux
...
fun DisconnectedView(
    ...
    Column(
        ...
        OutlinedTextField(
            value = serverUrl,
            supportingText = {
                Text(LocalFeedFlowStrings.current.minifluxUrlHint("https://miniflux.example.com"))
            },
        ...
        OutlinedTextField(
            ...
            supportingText = {
                Text(text = LocalFeedFlowStrings.current.minifluxPasswordHint)
            },
            trailingIcon = {
...
private fun ConnectedView(
    ...
    Column(
        ...
        Text(
            text = LocalFeedFlowStrings.current.minifluxAccountConnected,
        ...
        when (val syncState = uiState.syncState) {
            ...
            AccountSyncUIState.None -> {
                Text(
                    text = LocalFeedFlowStrings.current.noMinifluxSyncYet,
                ...
                if (lastDownload != null) {
                    Text(
                        modifier = Modifier
                            .padding(horizontal = Spacing.regular)
                            .padding(top = Spacing.small),
                        text = LocalFeedFlowStrings.current.minifluxLastSync(lastDownload),
                        style = MaterialTheme.typography.bodySmall,
                    )
                }
            }
