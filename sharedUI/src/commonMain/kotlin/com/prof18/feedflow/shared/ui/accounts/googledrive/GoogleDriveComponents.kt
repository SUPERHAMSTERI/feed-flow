package com.prof18.feedflow.shared.ui.accounts.googledrive
...
private fun ConnectedView(
    ...
    Column {
        Text(
            text = LocalFeedFlowStrings.current.googleDriveSyncSuccess,
        ...
        when (val syncState = uiState.syncState) {
            ...
            AccountSyncUIState.None -> {
                Text(
                    text = LocalFeedFlowStrings.current.noGoogleDriveSyncYet,
